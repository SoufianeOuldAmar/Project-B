        ...
        public static void UpdateBookedDetailsPresentation()
        {
            ...
            while (true)
            {
                ...
                if (bookings.Count == 0)
                {
                    ...
                    Console.ResetColor();
                    continue; // Ask for email again if no bookings found
                }
                ...
                if (int.TryParse(input, out int chosenFlightID))
                {
                    ...
                    {
                        DisplayBookingDetails(selectedBooking, email, flightDeatails);
                        ...
                        while (true)
                        {
                            ...
                            Console.Write("Choose an option (leave empty to keep current pets): ");
                            string choice = Console.ReadLine().ToLower();
                ...
                {
                    Console.WriteLine("Invalid FlightID. Please try again.");
                }
            }
        }
